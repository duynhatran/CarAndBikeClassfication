...
Đóng gói các ảnh thành batch:
	Chương trình không thể thực hiện việc lấy tất cả ảnh lên để xử lý cùng lúc, vì vậy các ảnh cần phải được đóng gói thành các batch rồi lần lượt đưa vào mô hình. Mỗi batch sẽ bao gồm 32 ảnh, mỗi ảnh được điều chỉnh lại thành mảng ma trận 60x60x3 (3 là giá trị RGB). 

<img width="392" alt="image" src="https://user-images.githubusercontent.com/83011808/222169274-acad756c-a9a0-407b-af9b-8e5dc44d3d3d.png">
...
https://user-images.githubusercontent.com/83011808/222169386-f8dc8469-8697-48a7-89ff-7ee63749f233.png
...
hai đại lượng: số dự đoán đúng (y) so với tổng số dự đoán (ŷ). 
